...
Custom permission classes for common authorization patterns.
"""
...
class IsOwner(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        # Get owner field name (default: 'user')
...
class HasActiveSubscription(permissions.BasePermission):
    """Only allow users with active subscription."""
    ...
    def has_permission(self, request, view):
        ...
        # Check subscription (assumes user has subscription field)
