"""
Store Inventory - Production-Ready Serializers.

DTOs for inventory management.
"""
...
class WarehouseSimpleSerializer(serializers.ModelSerializer):
    """Minimal warehouse for references."""
...
class StockItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_in_stock', 'is_low_stock', 'is_out_of_stock', 'needs_reorder',
            'stock_status', 'stock_value', 'unit_cost',
            'last_restocked_at', 'last_sold_at',
...
class InventoryCountListSerializer(serializers.ModelSerializer):
    """Simplified inventory count for listing."""
    status_display = serializers.CharField(source='get_status_display')
